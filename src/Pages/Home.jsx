    ...
    <div className="Home">
      ...
      <div className="sm:ps-12 max-w-screen-2xl m-auto">
        <div className="flex justify-between gap-10">
          <div className="sm:ms-[30px] max-w-lg pt-[200px] sm:ps-0 sm:pe-0 p-6">
            ...
            <div className="flex gap-6 sm:gap-20 mt-4 sm:mt-10 text-xs sm:text-base">
              <button className="bg-[#f6a13c] p-3 w-[150px] rounded-tl-3xl rounded-br-xl font-semibold">Explore</button>
      ...
      <div className="max-w-screen-xl m-auto mt-20 mb-20">
        <ul className="flex items-center justify-evenly bg-gray-200 ps-8 pe-8 pt-6 pb-6 rounded-full">
          <li>Amazon</li>
          <li>Citibank</li>
          <li>Applepay</li>
          <li>Walmart</li>
